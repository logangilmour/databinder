...
(def bind (uris "http://logangilmour.com/data-binder#" :js :debug :index :root :application :subject :object :children :template :from :path :view :base :param :name :binding :bind :object-binding :subject-binding :compiled))
