...
(def bind (uris "http://logangilmour.com/data-binder#" :js :debug :index :root :application :subject :object :children :template :filter :query :key :path :view :base :param :name :binding :bind :order-by :object-binding :subject-binding :compiled :uri :component))
